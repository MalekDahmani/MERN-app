      ...
      <div
        ...
        <Link to="/" className={classes("outline-none")}>
          <h1
            ...
            Workout <span className={classes("text-yellow-400")}>GYM</span>
          </h1>
        </Link>
        <Link to="/about" className={classes("outline-none")}>
          <h3
            className={classes(
              "text-lg font-semi-bold leading-relaxed text-white",
              "uppercase tracking-widest underline underline-offset-4",
             ...
             <span className={classes("text-yellow-400")}>About</span>
          </h3>
        </Link>
        <Link to="/nutrition" className={classes("outline-none")}>
          <h3
            className={classes(
              "text-lg font-semi-bold leading-relaxed text-white",
              "uppercase tracking-widest underline underline-offset-4",
             ...
             <span className={classes("text-yellow-400")}>Nutrition</span>
          </h3>
        </Link>
